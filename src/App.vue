      ...
      <v-navigation-drawer
        ...
        <v-list>
          <v-list-tile>
            ...
            ><v-icon class="pa-1">close</v-icon></v-list-tile-action
            >
          </v-list-tile>
          <v-list-tile
            class="list-tile"
            to="/">
            <v-list-tile-action
            ><v-icon color="primary">dashboard</v-icon></v-list-tile-action
            >
            <v-list-tile-content
          ...
          <v-list-tile
            class="list-tile"
            to="/blog/home">
            <v-list-tile-action><v-icon>ballot</v-icon></v-list-tile-action>
            <v-list-tile-content>
          ...
          <v-list-tile
            ...
            to="/currency">
            <v-list-tile-action
            ><v-icon>attach_money</v-icon></v-list-tile-action
            >
            <v-list-tile-content>
          ...
          >
            <v-list-tile-action
            ><v-icon>collections</v-icon></v-list-tile-action
            >
            <v-list-tile-content>
...
export default {
  ...
  methods: {
    ...
    errorChecked() {
      this.$store.dispatch('tooManyRequestsAlert', false);
    },
  },
};
</script>
